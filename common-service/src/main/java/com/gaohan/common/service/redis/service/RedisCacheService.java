package com.gaohan.common.service.redis.service;
...
public interface RedisCacheService {
     ...
     * @return
     */
    Long delByPrefixKey(String keyPattern);
     ...
     * @return
     */
    Long zadd(String key, Map<String, Double> scoreMembers, boolean overwrite);
    ...
    /**
     * 通过key返回指定score内zset中的value(按顺序区间)
     * @param key
     * @param start
     * @param end
     * @return
    ...
    /**
     * 为给定 key 设置默认生存时间，当 key 过期时(生存时间为 0 )，它会被自动删除。
     * @param key
     * @return
     */
    ...
    /**
     * list,set,zset的排序，按照给定的key，对value进行从小到大的排序
     * @param key
     * @return
     */
    ...
    /**
     * list,set,zset的排序，按照给定的key以及排序规则排序，具体见jedis->sort(final String key, final SortingParams sortingParameters)
     * example:
